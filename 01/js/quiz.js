...
if(pageArray[curPage][3] == "run"){
	document.write('<link href="../01/css/run.css"  rel="stylesheet" />');
}
...
//BGM 영역
	...
	var quiz1A_bgmring = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/ring.mp3');
	...
	var quiz3A_bgmover = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/wrong.mp3');
	...
	//BGM
	var quiz7_bgmright = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/right.mp3');
	var quiz7_bgmover = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/wrong.mp3');
	var quiz7_bgmclick = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/click.mp3');
	//BGM
	var quiz7_bgmright = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/right.mp3');
	var quiz7_bgmover = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/wrong.mp3');
	var quiz7_bgmclick = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/click.mp3');
	...
	// BGM
	var bgm = new Audio('https://hunetdown.cdn.hunet.co.kr/eLearning/Hunet/Sounds/HLAC00343/run_rider1.mp3');
	...
	// 모든 Audio 객체를 배열에 추가
	var audioArray = [
    quiz1A_bgmclick, quiz1A_bgmright, quiz1A_bgmover, quiz1A_bgmring, quiz1A_bgmmessage, quiz1A_bgm,
    ...
    quiz7_bgmright, quiz7_bgmover, quiz7_bgmclick,
    quiz9A_bgmclick,
    quiz9B_bgmclick,
...
function setQuiz(){
	if(quizCategory == 1){ // 타입1 일방 퀴즈 ////////////////////////////////////////////////////////////////////////////////
			...
			if(pageArray[curPage][2] == 1 && quizAtoB1 == 0){
				...
				// 핸드폰
				quizStr += '				<div class="phone1"></div>'; // 폰 베이스
				quizStr += '				<div class="phone2"></div>'; // 중앙폰 시작
				quizStr += '				<div class="phone3"></div>'; // 중앙폰 퀴즈 이후
				quizStr += '				<div class="phone4"></div>'; // 오답시 중앙폰 전화옴
				// 퀴즈 초이스
				quizStr += '				<div class="quizchoice">'; // 퀴즈 선택지
				quizStr += '					<div class="btn1"></div>';
				quizStr += '					<div class="btn2"></div>';
				quizStr += '				</div>';
				// 사람
				quizStr += '				<div class="human1"></div>'; // 박대리
				quizStr += '				<div class="human2"></div>'; // 박대리2
				quizStr += '				<div class="humanx1"></div>'; // 오답박대리1
				quizStr += '				<div class="humanx2"></div>'; // 오답박대리2
				// 하단자막 3개
				quizStr += '				<div class="script1"></div>'; // 무료식사권
				quizStr += '				<div class="script2"></div>'; // 박대리 즐거운 시간 보내
				quizStr += '				<div class="scripto1"></div>'; // 정답1
				quizStr += '				<div class="scripto2"></div>'; // 정답2
				quizStr += '				<div class="scriptx1"></div>'; // 오답1
				quizStr += '				<div class="scriptx2"></div>'; // 오답2
				quizStr += '				<div class="scriptx3"></div>'; // 오답2
				// 결과 화면
				...
				function quiz1AOn() {
					...
					$("#type1.typeA .quiz1start").on("click", function () {
						...
						quiz1A_bgm.play()
						$(this).hide()
						$("#type1.typeA").css("background","url(../01/img/quiz/01/01/A_background_2.png)")
						$("#type1.typeA").css("background-size","1280px")
						$("#type1.typeA .phone1").show()
						ani1()
					})
					
					$("#type1.typeA .btn1").on("click", function () {
						quiz1A_bgmclick.play()
						aniwrong()
					})
					$("#type1.typeA .btn2").on("click", function () {
						quiz1A_bgmclick.play()
						anianswer()
					})
					...
					function ani1(){
						setTimeout(() => {
							...
							$("#type1.typeA .script1").fadeIn(300)
						}, 500);
						setTimeout(() => {
							$("#type1.typeA .human1").fadeIn(300)
						}, 2000);
						setTimeout(() => {
							quiz1A_bgmmessage.play()
							$("#type1.typeA .script2").fadeIn(300)
						}, 3500);
						setTimeout(() => {
							$("#type1.typeA .human1").hide(300)
							$("#type1.typeA .human2").fadeIn(300)
						}, 5000);
						setTimeout(() => {
							$("#type1.typeA .human1").hide()
							$("#type1.typeA .script1").hide()
							$("#type1.typeA .script2").hide()
							$("#type1.typeA .human2").hide()
							$("#type1.typeA .phone1").hide()
						}, 7500);
						setTimeout(() => {
							$("#type1.typeA .phone2").fadeIn(300)
						}, 8000);
						setTimeout(() => {
							$("#type1.typeA .quizchoice").fadeIn(300)
						}, 10500);
					...
					function anianswer(){ // 성공 애니메이션
						$("#type1.typeA .quizchoice").hide()
						$("#type1.typeA .phone2").hide()
						$("#type1.typeA .phone3").show()

						setTimeout(() => {
							$("#type1.typeA .scripto1").fadeIn()
							quiz1A_bgmmessage.play()
						}, 1000);

						setTimeout(() => {
							$("#type1.typeA .scripto2").fadeIn()
							quiz1A_bgmmessage.play()
						}, 3000);
					...
					function aniwrong(){ // 실패 애니메이션
						...
						setTimeout(() => {
							$("#type1.typeA .scriptx1").fadeIn(300)
							quiz1A_bgmmessage.play()
						}, 1000);
						
						setTimeout(() => {
							$("#type1.typeA .scriptx2").fadeIn(300)
							quiz1A_bgmmessage.play()
						}, 3000);

						setTimeout(() => {
							$("#type1.typeA .scriptx1").hide()
							$("#type1.typeA .scriptx2").hide()
							$("#type1.typeA .phone3").hide()
							$("#type1.typeA .phone4").show()
							quiz1A_bgmring.play()
						}, 5000);

						setTimeout(() => {
							$("#type1.typeA .humanx1").fadeIn(300)
							quiz1A_bgmmessage.play()
						}, 8000);

						setTimeout(() => {
							$("#type1.typeA .scriptx3").fadeIn(300)
							quiz1A_bgmmessage.play()
						}, 9500);

						setTimeout(() => {
							$("#type1.typeA .humanx1").hide()
							$("#type1.typeA .humanx2").fadeIn(300)
						}, 11500);
						...
						setTimeout(() => {
							$("#type1.typeA .retry").on("click", function () {
								...
								$(this).hide()
								$("#type1.typeA .humanx2").hide()
								$("#type1.typeA .scriptx3").hide()
								$("#type1.typeA .phone4").hide()
								$("#type1.typeA .phone3").show()
								$("#type1.typeA .quizchoice").show()
								quiz1A_bgmclick.play()
							})
							$("#type1.typeA .retry").fadeIn(300)
						}, 16000);
					}
				}
			}
		...
		if(pageArray[curPage][2] == 1 && quizAtoB2 == 0){
			...
			$("#type2.typeA .intrash").on("click", function () {
				quiz2A_bgmclick.play()
				$("#type2.typeA .trash").css("background","url(../01/img/quiz/02/01/trash_f.png)")
				$("#type2.typeA .trash").css("background-size","196px 107px")
				$("#type2.typeA .trash").css("pointer-events","auto")
				$("#type2.typeA .object" + objectSelect).css("background","url(../01/img/quiz/02/01/object_null.png)")
			...
			$("#type2.typeA .trash").on("click", function () {
				...
				// 빈 쓰레기통 클릭
				if(trashsituation == 0){
					$("#type2.typeA .object1").css("background","url(../01/img/quiz/02/01/object1_o.png)")
					$("#type2.typeA .object1").css("background-size","281px")
					$("#type2.typeA .object2").css("background","url(../01/img/quiz/02/01/object2_o.png)")
					$("#type2.typeA .object2").css("background-size","281px")
					$("#type2.typeA .object3").css("background","url(../01/img/quiz/02/01/object3_o.png)")
					$("#type2.typeA .object3").css("background-size","281px")
					$("#type2.typeA .object4").css("background","url(../01/img/quiz/02/01/object4_o.png)")
				...
				// 채워진 쓰레기통 클릭
					...
					//게임 성공
					if(objectSelect == 3){
						$("#type2.typeA .object1").css("background","url(../01/img/quiz/02/01/object1_x.png)")
						$("#type2.typeA .object1").css("background-size","281px")
						$("#type2.typeA .object2").css("background","url(../01/img/quiz/02/01/object2_x.png)")
						$("#type2.typeA .object2").css("background-size","281px")
						$("#type2.typeA .object4").css("background","url(../01/img/quiz/02/01/object4_x.png)")
						$("#type2.typeA .object4").css("background-size","281px")
					...
					//찬스 1번
						...
						objectSelect = 0; //선택된 쓰레기 초기화
						$("#type2.typeA .trash").css("background","url(../01/img/quiz/02/01/trash_n.png)")
						$("#type2.typeA .trash").css("background-size","196px 107px")
		...
		// B타입 퀴즈 스타트
			...
			function quiz2BOn() {
				...
				$("#type2.typeB .object1").on("click", function () {
					...
					$("#type2.typeB .object").css("pointer-events","none")
					objectSelect = 1;
				...
				function anwserCheck() {
					//게임 성공
					if(objectSelect == 3){
						$("#type2.typeB .card1").addClass("flipped")
						$("#type2.typeB .card2").addClass("flipped")
						$("#type2.typeB .card3").addClass("flipped")
						$("#type2.typeB .card4").addClass("flipped")
					...
					//게임 실패
						...
						$("#type2.typeB .card1").removeClass("flipped")
						$("#type2.typeB .card2").removeClass("flipped")
						$("#type2.typeB .card3").removeClass("flipped")
						$("#type2.typeB .card4").removeClass("flipped")
						quiz2B_bgmover.play()
						setTimeout(() => {
							$("#type2.typeB .object").css("pointer-events","auto")
						}, 500);
					}
				}
		...
		// 타입 지정 오류
			...
			if(pageArray[curPage][2] == 1 && quizAtoB3 == 0){
				...
				function quiz3AOn() {
					...
					var anwsercount = [0,0]; //정답을 저장할 배열 1, 6이 정답
					...
					$("#type3.typeA .object").on("click", function () {
						quiz3A_bgmclick.play()
						$(this).css("margin-top","500px")
					})
					$("#type3.typeA .object1").on("click", function () {addnumber = 1; anwsercountadd();})
					$("#type3.typeA .object2").on("click", function () {addnumber = 2; anwsercountadd();})
					$("#type3.typeA .object3").on("click", function () {addnumber = 3; anwsercountadd();})
					$("#type3.typeA .object4").on("click", function () {addnumber = 4; anwsercountadd();})
					$("#type3.typeA .object5").on("click", function () {addnumber = 5; anwsercountadd();})
					$("#type3.typeA .object6").on("click", function () {addnumber = 6; anwsercountadd();})
				
					function anwsercountadd() {
						howmanynumber ++ ; //클릭횟수 증가
						if(!$(".anwser1").hasClass("on")){
							$(".anwser1").addClass("on")
							$(".anwser1").css("background","url('../01/img/quiz/03/01/answer_" + addnumber + ".png')")
							$(".anwser1").css("background-size","88px")
						}
						else if($(".anwser1").hasClass("on") && !$(".anwser2").hasClass("on")){
							$(".anwser2").addClass("on")
							$(".anwser2").css("background","url('../01/img/quiz/03/01/answer_" + addnumber + ".png')")
						...
						if(anwsercount[0] == 0){
							...
							$("#type3.typeA .object").css("pointer-events","none") // 더이상 클릭하지 못하게
						}
						else{
							console.log("정답체크")
						}
					...
					function quizchack() {
						...
						setTimeout(() => {
							...
							// 정답 퀴즈 완료
							if(anwsercount[0] == 1 && anwsercount[1] == 6){
								quizclear()
							}
							else{
								// 오답
								...
								quiz3A_bgmover.play()
								$("#type3.typeA .quizretry").fadeIn(300)
								setTimeout(() => {
								$("#type3.typeA .quizretry").fadeOut(300)
								}, 2000);
								anwsercount = [0,0]; //배열 초기화
								$("#type3.typeA .object").css("pointer-events","auto") // 클릭 초기화
								// 찬스 감소
								if(chance > 0){
									chance --;
								}
								if(chance == 0){
									chance = -1
									$("#type3.typeA .object1").css("background","url('../01/img/quiz/03/01/object1_hint.png')") //힌트 이미지로 변경
									$("#type3.typeA .object6").css("background","url('../01/img/quiz/03/01/object6_hint.png')") //힌트 이미지로 변경
									$("#type3.typeA .object1").css("background-size","263px 133px") //정답 초기화
									$("#type3.typeA .object6").css("background-size","263px 133px") //정답 초기화
								}
								$("#type3.typeA .object1").css("margin-top","0") //위치 초기화
								$("#type3.typeA .object2").css("margin-top","0") //위치 초기화
								$("#type3.typeA .object3").css("margin-top","0") //위치 초기화
								$("#type3.typeA .object4").css("margin-top","0") //위치 초기화
								$("#type3.typeA .object5").css("margin-top","0") //위치 초기화
								$("#type3.typeA .object6").css("margin-top","0") //위치 초기화
								$(".anwser1").css("background","url('../01/img/quiz/03/01/null.png')") //정답 초기화
								$(".anwser2").css("background","url('../01/img/quiz/03/01/null.png')") //정답 초기화
					...
					function quizclear() {
						...
						$(".anwser1").css("background","url('../01/img/quiz/03/01/answer_1_e.png')") //정답 초기화
						$(".anwser2").css("background","url('../01/img/quiz/03/01/answer_6_e.png')") //정답 초기화
						$(".anwser1").css("background-size","88px") //정답 초기화
						$(".anwser2").css("background-size","88px") //정답 초기화
						$("#type3.typeA .quizclear").fadeIn(300)
						setTimeout(() => {
							$("#type3.typeA .quizclear").fadeOut(300)
						}, 2000);
						setTimeout(() => {
		...
		if(pageArray[curPage][2] == 1){
			...
			function rungame(){
				...
				function setRun(){
					var runStr = "";
							...
							runStr += '		</div>';
							runStr += '  		<img id="player" src = "../01/img/run/human.png">';
				...
				function checkForFail() {
					...
					if(gameclear == 1 && $(".pit").length == 0){
						...
						if(gameover == 0){
							...
							setTimeout(() => {
								trackbraek = 1;
								$("#player").attr("src","../01/img/run/human.png");
							}, 1200);
				...
				function addPit() {
					if(!trackbraek){
						...
						var positions = ['calc(42% - 50px)', 'calc(47% - 50px)', 'calc(51% - 50px)'];
						...
						$('#runcontent').append(p);
						// 장애물이 떨어지는 속도
						$(".location0").animate({ top : "100%", left : "17%"},pitspeed*3, "linear")
						$(".location1").animate({ top : "100%", left : "43%"},pitspeed*3, "linear")
						$(".location2").animate({ top : "100%", left : "67%"},pitspeed*3, "linear")
						// 남은 장애물 체크
						if(gameover == 0){
							setTimeout(() => {
				...
				function Runfunction() {
					...
					infoupdate()
					// 플레이어 gif 이미지로 변경
					$("#player").attr("src","../01/img/run/human-move.gif");
			...
			if(pageArray[curPage][2] == 1 && quizAtoB5 == 0){
				...
				function quiz5AOn() {
						...
						canvas.width = 1100;  // 초기 canvas 크기 설정
						canvas.height = 301;
		...
		function boxOn(){
			...
			if(pageArray[curPage][2] == 1 && quizAtoB9 == 0){
				...
				function quiz9AOn() {
					...
					$("#type9.typeA .click").on("click", function () {
						...
						if(A9clickcount == 3){
							$("#type9.typeA").css("background","url(../02/img/quiz/09/01/A_background_2.png)")
							$("#type9.typeA").css("background-size","1280px")
						}
						else if(A9clickcount == 2){
							$("#type9.typeA").css("background","url(../02/img/quiz/09/01/A_background_3.png)")
							$("#type9.typeA").css("background-size","1280px")
						}
						else if(A9clickcount == 1){
							$("#type9.typeA").css("background","url(../02/img/quiz/09/01/A_background_4.png)")
							$("#type9.typeA").css("background-size","1280px")
							$(this).hide()
						}
			...
			// B타입 퀴즈 스타트
				...
				function quiz9BOn() {
					...
					//변수
					var B9clickcount = 1; // 5개 누르면 완료 버튼띄우기
					
					$("#type9.typeB .start").on("click", function () {
						$(this).hide()
						quiz9B_bgmclick.play()
						$("#type9.typeB").css("background","url(../02/img/quiz/09/02/B_background_1.png)")
						$("#type9.typeB").css("background-size","1280px")
						setTimeout(() => {
					...
					quiz9B_bgmclick.play()
					if(B9clickcount == 1){
						$("#type9.typeB").css("background","url(../02/img/quiz/09/02/B_background_2.png)")
						$("#type9.typeB").css("background-size","1280px")
						$(this).hide()
					  }
